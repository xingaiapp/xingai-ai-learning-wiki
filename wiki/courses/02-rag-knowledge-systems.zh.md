...
- 营销类"RAG 一栏"海报通常止步于 embed→向量数据库——批判见
  [MCP vs RAG vs Skills](../syntheses/mcp-vs-rag-vs-skills.zh.md);阶梯切法见
  [RAG vs Agentic RAG](../syntheses/rag-vs-agentic-rag-vs-xingai.zh.md)。
- 证据环 + Knowledge Base API 地图：[ai-architecture-digest-2026-07-17](../syntheses/ai-architecture-digest-2026-07-17.zh.md)。
