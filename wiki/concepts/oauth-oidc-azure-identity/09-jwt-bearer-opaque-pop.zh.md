# 09. JWT、Bearer、不透明令牌与 PoP

English: [09-jwt-bearer-opaque-pop.md](09-jwt-bearer-opaque-pop.md)

属于 [OAuth / OIDC / Azure Identity 目录](00-overview.zh.md)。  
**主要教学来源：** [课程 10 · 模块 09](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/09-jwt-bearer-opaque-pop.zh.md) · [主页](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/README.zh.md)
...
- 课程 10 模块 09 给出上文词汇、图示与失败关闭校验（`raw/xingai-enterprise-ai-design/courses/10-oauth-oidc-azure-identity/modules/09-jwt-bearer-opaque-pop.zh.md`；公开：[模块](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/09-jwt-bearer-opaque-pop.zh.md)）。
...
- 课程模块保持精简——本 wiki 页无「JWT, Bearer, Opaque, and PoP Tokens」的真实令牌追踪。
...
- 课程：[JWT、Bearer、不透明令牌与 PoP](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/09-jwt-bearer-opaque-pop.zh.md) · [EN](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/09-jwt-bearer-opaque-pop.md)
- 快照：`raw/xingai-enterprise-ai-design/courses/10-oauth-oidc-azure-identity/modules/09-jwt-bearer-opaque-pop.zh.md`
