...
**主要教学来源：** [课程 10 · 模块 19](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/19-api-keys-and-pats.zh.md) · [主页](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/README.zh.md)
...
- 课程 10 模块 19 给出上文词汇、图示与失败关闭校验（`raw/xingai-enterprise-ai-design/courses/10-oauth-oidc-azure-identity/modules/19-api-keys-and-pats.zh.md`；公开：[模块](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/19-api-keys-and-pats.zh.md)）。
...
- 无「API Keys and PATs」的真实 Entra 租户截图——课程把 Azure 当映射，而非必选云。
...
- 课程：[API Key 与 PAT](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/19-api-keys-and-pats.zh.md) · [EN](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/19-api-keys-and-pats.md)
- 快照：`raw/xingai-enterprise-ai-design/courses/10-oauth-oidc-azure-identity/modules/19-api-keys-and-pats.zh.md`
