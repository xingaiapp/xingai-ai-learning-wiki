...
- No live Entra tenant screenshots for “Managed Identity and Workload Identity” — course treats Azure as a mapping, not a required cloud.
...
- Course: [Managed Identity and Workload Identity](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/16-managed-identity-workload-identity.md) · [中文](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/16-managed-identity-workload-identity.zh.md)
- Snapshot: `raw/xingai-enterprise-ai-design/courses/10-oauth-oidc-azure-identity/modules/16-managed-identity-workload-identity.md`
