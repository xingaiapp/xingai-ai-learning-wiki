...
**主要教学来源：** [课程 10 · 模块 18](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/18-session-and-cookie-security.zh.md) · [主页](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/README.zh.md)
...
- 课程 10 模块 18 给出上文词汇、图示与失败关闭校验（`raw/xingai-enterprise-ai-design/courses/10-oauth-oidc-azure-identity/modules/18-session-and-cookie-security.zh.md`；公开：[模块](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/18-session-and-cookie-security.zh.md)）。
...
- 无「Session and Cookie Security」的真实 Entra 租户截图——课程把 Azure 当映射，而非必选云。
...
- 课程：[会话与 Cookie 安全](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/18-session-and-cookie-security.zh.md) · [EN](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/18-session-and-cookie-security.md)
- 快照：`raw/xingai-enterprise-ai-design/courses/10-oauth-oidc-azure-identity/modules/18-session-and-cookie-security.zh.md`
