...
**主要教学来源：** [课程 10 · 模块 16](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/16-managed-identity-workload-identity.zh.md) · [主页](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/README.zh.md)
...
- 课程 10 模块 16 给出上文词汇、图示与失败关闭校验（`raw/xingai-enterprise-ai-design/courses/10-oauth-oidc-azure-identity/modules/16-managed-identity-workload-identity.zh.md`；公开：[模块](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/16-managed-identity-workload-identity.zh.md)）。
...
- 无「Managed Identity and Workload Identity」的真实 Entra 租户截图——课程把 Azure 当映射，而非必选云。
...
- 课程：[托管标识与工作负载标识](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/16-managed-identity-workload-identity.zh.md) · [EN](https://github.com/xingaiapp/xingai-enterprise-ai-design/blob/main/courses/10-oauth-oidc-azure-identity/modules/16-managed-identity-workload-identity.md)
- 快照：`raw/xingai-enterprise-ai-design/courses/10-oauth-oidc-azure-identity/modules/16-managed-identity-workload-identity.zh.md`
