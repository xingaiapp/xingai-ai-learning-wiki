...
- Every course page (see [the course list in index.md](../index.md#courses-wikicourses)) — first taught explicitly in [Course 00](../courses/00-ai-foundations.md), then assumed for the rest.
- `COURSE-STANDARD.md`'s Bilingual Parity rule extends this: English and Chinese must preserve the same section order, not just the same words — verified true across the samples spot-checked this session (Course 00 and Course 04's `.zh.md` siblings).
