...
放在 `wiki/assets/ux/`。最新外部摄入:**2026-07-19** AI Systems 人体类比海报(Aiswarya 仅参考 + XingAI 任务地图)、
Loop Engineering 工具包海报,以及 MCP vs A2A vs ACP。跳过项:`xingai-ai-learning-wiki`(自身)、
